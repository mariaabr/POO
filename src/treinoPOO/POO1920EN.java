...
public class POO1920EN {
	...
	private static void alinea1(PrintStream out) {
		...
		Eletrodomestico electr1 = new Eletrodomestico("Frigor�fico", "Bosch","XPTO",1000.0, 780.0);
		Eletrodomestico electr2 = new Eletrodomestico("Fog�o","AEG","XYZ",423.0); // tipo, marca, modelo, pre�o
		...
		//
		Eletrodomestico tv1=new Eletrodomestico("Televisor","LG","MODEL X",450.0);
	...
	**/
	private static void alinea2(PrintStream out) {
		...
		// 			switch(line[0]) {
		// 			case "TELEM":
		// 				temp1 = new Telemovel(line[1], line[2], Double.parseDouble(line[3].strip()));
		// 				temp1.addStock(Integer.parseInt(line[4].strip()));
		// 				loja.add(temp1);
		// 				break;
		// 			case "ELECT":
		// 				temp2 = new Eletrodomestico(line[1], line[2], line[3], Double.parseDouble(line[4].strip()));
        ...
        //     for(Produto p : loja.produtosPrecoFinalSuperiorA(500)){
        //         out.printf("%-30s%-20s\n", p.getDescricao(), p.precoVendaAoPublico()+" Euros");
        //     }
        //     out.println();
			 
		// 	out.println("Lista de Electrodom�sticos com Classe A:");
        //     for(Produto p : loja.electrodomesticosClasseX("A")){
        //         out.printf("%-30s%-20s\n", p.getDescricao(), p.precoVendaAoPublico()+" Euros  A");
        //     } 
		}
	}
}
